                ...
                || buffer_info.flags.timestamp_error)
        {
            ...
            if estimate.aec_reset_required {
                ...
                diag_log_detail(
                    ...
                    format!(
                        "direction={} reason={} renderDiscontinuityId={} dataDiscontinuity={} timestampError={} capturePaddingInvalid={} delayResetRequired={} packetDeviceFrameIndex={} queueHeadDeviceFrameIndex={} packetTimestamp100ns={} queueHeadTimestamp100ns={} queuedCaptureFrames={} previousQueueHeadDeviceFrameIndex={:?} currentQueueHeadDeviceFrameIndex={} queueHeadDeviceFrameDelta={:?} previousQueueHeadTimestamp100ns={:?} currentQueueHeadTimestamp100ns={} queueHeadTimestampDelta100ns={:?} paddingFrames={:?} bufferFrames={} delayMs={:.1} delaySource={} estimatorResetCount={} timestampErrorCount={}",
                        direction,
                        reset_reason,
                        render_clock.discontinuity_count,
                        buffer_info.flags.data_discontinuity,
