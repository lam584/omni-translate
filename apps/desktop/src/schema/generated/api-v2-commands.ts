...
export type ProviderCommandV2 = { "action": "fetchModels", provider: unknown, } | { "action": "probe", provider: unknown, } | { "action": "smoke", provider: unknown, sourceText?: string, sourceLanguage?: string, targetLanguage?: string, } | { "action": "runModelBenchmark", model: string, apiKey: string, mp3Path: string, runId: string, realtimeAudioMode?: string, interactionCapabilities?: Array<string>, providerKind?: string, baseUrl?: string, authHeaderName?: string, authScheme?: string, };
