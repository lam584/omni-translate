...
export type ModelProtocolProfileIdentityRuntime = { registryVersion: string, profileId: string, profileVersion: number, operation: string, transport: string, region: string, endpointFamily: string, endpointPath: string, wireDialect: string, wireDialectVersion: number, inputFraming: string, outputFraming: string, terminalLifecycle: string, adapterId: string, exactModelId: string, };

export type WatchSessionReportRuntime = { sessionId: string, status: 'active' | 'completed', routeMode: string, providerId: string, model: string, modelProtocolProfileIdentity?: ModelProtocolProfileIdentityRuntime, startedAt: string, endedAt: string | null, elapsedMs: number, summary: WatchSessionReportSummaryRuntime, cues: Array<WatchCueComparisonRuntime>, events: Array<WatchTimelineEventRuntime>, issues: Array<WatchIssueRuntime>, droppedCueCount: number, droppedEventCount: number, };
