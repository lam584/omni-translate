...
export type DiagnosticsRuntimeSnapshot = { status: string, supportTier: string, installStatus: string, providerStatus: string, driverStatus: string, deviceStatus: string, lastSelfCheckAt: string | null, lastExportScope: string | null, lastExportPath: string | null, lastExportedAt: string | null, categories: Array<DiagnosticLogCategoryRuntime>, supportMatrix: Array<DiagnosticSupportSignalRuntime>, modelTraceSummary: ModelTraceSummaryRuntime, recentLogs: Array<DiagnosticLogEntryRuntime>, recentErrors: Array<DiagnosticLogEntryRuntime>, 
/**
