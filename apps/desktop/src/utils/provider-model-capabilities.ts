...
const seedRegistryEntries: SeedRegistryEntry[] = [
  {
    ...
    interactionCapabilities: ['auto_vad', 'manual_commit', 'streaming'],
    apiModes: ['live-websocket'],
    releasedAt: '2025-08-28',
    source: 'official',
  },
  {
    id: 'seed-openai-gpt-realtime-2.1',
  ...
  {
    id: 'seed-openai-gpt-realtime-2.1-mini',
  ...
  },
  {
    ...
    capabilities: ['speech-to-text', 'speech-to-speech'],
    realtimeAudioMode: 'server_vad',
    interactionCapabilities: ['streaming', 'pipeline_asr_mt_tts'],
    apiModes: ['live-websocket'],
    releasedAt: '2026-05-07',
    source: 'official',
    notes: '专用实时翻译（源语+译文双字幕）',
  },
  {
    ...
    interactionCapabilities: ['manual_commit', 'streaming'],
  ...
  {
    id: 'seed-hunyuan-translation-lite',
    modelId: 'hunyuan-translation-lite',
    capabilities: ['speech-to-text'],
    realtimeAudioMode: 'server_vad',
    interactionCapabilities: ['streaming', 'pipeline_asr_mt_tts'],
    apiModes: ['live-websocket'],
  ...
  { id: 'seed-qwen3.5-omni-plus-realtime-2026-03-15', modelId: 'qwen3.5-omni-plus-realtime-2026-03-15', capabilities: ['speech-to-text', 'text-to-speech', 'speech-to-speech'], realtimeProtocol: 'dashscope-omni', realtimeAudioMode: 'semantic_vad', interactionCapabilities: ['auto_vad', 'manual_commit', 'streaming', 'push_to_talk'], releasedAt: '2026-03-15', source: 'official' },
  ...
  { id: 'seed-qwen3.5-omni-flash-realtime', modelId: 'qwen3.5-omni-flash-realtime', capabilities: ['speech-to-text', 'text-to-speech', 'speech-to-speech'], realtimeProtocol: 'dashscope-omni', realtimeAudioMode: 'semantic_vad', interactionCapabilities: ['auto_vad', 'manual_commit', 'streaming', 'push_to_talk'], releasedAt: '2026-03-29', source: 'official' },
  { id: 'seed-qwen3.5-omni-flash-realtime-2026-03-15', modelId: 'qwen3.5-omni-flash-realtime-2026-03-15', capabilities: ['speech-to-text', 'text-to-speech', 'speech-to-speech'], realtimeProtocol: 'dashscope-omni', realtimeAudioMode: 'semantic_vad', interactionCapabilities: ['auto_vad', 'manual_commit', 'streaming', 'push_to_talk'], releasedAt: '2026-03-15', source: 'official' },
