...
#define SPEAKER_HOST_MIN_SAMPLE_RATE                48000   // Fixed Bridge ABI sample rate
#define SPEAKER_HOST_MAX_SAMPLE_RATE                48000   // Fixed Bridge ABI sample rate
...
#define SPEAKER_OFFLOAD_MIN_SAMPLE_RATE             48000   // Fixed Bridge ABI sample rate
...
{
    OMNI_SPEAKER_PCM48_STEREO_FORMAT
};
...
#undef OMNI_SPEAKER_PCM48_STEREO_FORMAT
