...
const reportLines = (generatedAt, provenance) => [
  ...
  ...scenario(
    ...
    'Use the fixed qwen3.5-livetranslate-flash-realtime pairwise-live/process-exclusion/default-speaker cell from the current canonical strict Watch Mode schema-v6 budget-balanced authority. The assembler re-verifies the complete LiveTranslate-only release plan, copies the selected cell receipt and fixed raw inventory, and proves that Desktop-generated translated cues completed through Bridge-owned physical playback on the actual Windows MMDevice endpoint.',
    [
      '- CollectorProfile: omni.release.real-device-audio/v1',
      '- AuthorityStatus: ready (canonical strict Watch Mode schema-v6 budget-balanced authority; requires the complete current-HEAD live matrix)',
